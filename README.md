...
An updated page rank vector computation method was created using both pagerank and word embeddings to find high quality results. The new model uses the keyword as well as the five most similar words, as found from the 'glove-twitter-25' model, to conduct its search. The previous results were re-generated from applying the new method in 'pagerank1.py' to the website "lawfareblog.com", and are given below. 

```
$ python pagerank1.py --data=./lawfareblog.csv.gz --search_query='corona'
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --search_query='trump'
INFO:gensim.models.keyedvectors:precomputing L2-norms of word weight vectors
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --search_query='iran'
INFO:gensim.models.keyedvectors:precomputing L2-norms of word weight vectors
...
$ python pagerank1.py --data=./lawfareblog.csv.gz
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --filter_ratio=0.2
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --alpha=0.99999
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --filter_ratio=0.2 --alpha=0.99999
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --filter_ratio=0.2 --personalization_vector_query='corona'
INFO:gensim.models.keyedvectors:precomputing L2-norms of word weight vectors
...
$ python pagerank1.py --data=./lawfareblog.csv.gz --filter_ratio=0.2 --search_query='corona'
INFO:gensim.models.keyedvectors:precomputing L2-norms of word weight vectors
